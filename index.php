...
<head>
   ...
   <!-- site metas -->
   <title>I n s t a n t - K a r m a</title>
...
<body>
         ...
         <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
               ...
               <div class="carousel-item">
                  <div class="container">
                     <h1 class="banner_taital">Counter-Strike Servers</h1>
                     <p class="banner_text">Servidores de Counter-Strike 1.6 e Counter-Strike: Source com 32 vagas, addons, AMX Mod X, MetaMod, HLGuard, VAC </p>
                     <div class="read_bt"><a href="servers.php">Ver servidores</a></div>
                  </div>
               </div>
            </div>
   ...
   <!-- header section end -->
      <!-- top 5 server section start -->
      <div class="container-fluid">
      <h1 class="services_taital text-center">Ranking KF2 Servers </h1>
      <?php include 'rankingtableindex.php'; ?>
   </div>
   <!-- top 5 server section end -->
         ...
         <div class="services_section_2">
            <div class="row justify-content-center">
               <div class="col-md-4">
                  ...
                  <div class="btn_main"><a href="#">Counter-Strike</a></div>
               </div>
               <div class="col-md-4">
                  <div><img src="images/img-2.png" class="services_img"></div>
                  <div class="btn_main active"><a href="#">Killing Floor 2</a></div>
               </div>
